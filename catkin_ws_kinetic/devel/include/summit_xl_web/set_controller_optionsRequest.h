// Generated by gencpp from file summit_xl_web/set_controller_optionsRequest.msg
// DO NOT EDIT!


#ifndef SUMMIT_XL_WEB_MESSAGE_SET_CONTROLLER_OPTIONSREQUEST_H
#define SUMMIT_XL_WEB_MESSAGE_SET_CONTROLLER_OPTIONSREQUEST_H
...
struct set_controller_optionsRequest_
{
  typedef set_controller_optionsRequest_<ContainerAllocator> Type;

  set_controller_optionsRequest_()
    : takeOver(false)
    , kinematicMode()
  ...
  set_controller_optionsRequest_(const ContainerAllocator& _alloc)
    : takeOver(false)
  ...
  typedef boost::shared_ptr< ::summit_xl_web::set_controller_optionsRequest_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::summit_xl_web::set_controller_optionsRequest_<ContainerAllocator> const> ConstPtr;

}; // struct set_controller_optionsRequest_

typedef ::summit_xl_web::set_controller_optionsRequest_<std::allocator<void> > set_controller_optionsRequest;

typedef boost::shared_ptr< ::summit_xl_web::set_controller_optionsRequest > set_controller_optionsRequestPtr;
typedef boost::shared_ptr< ::summit_xl_web::set_controller_optionsRequest const> set_controller_optionsRequestConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::summit_xl_web::set_controller_optionsRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::summit_xl_web::set_controller_optionsRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::summit_xl_web::set_controller_optionsRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::summit_xl_web::set_controller_optionsRequest_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::summit_xl_web::set_controller_optionsRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::summit_xl_web::set_controller_optionsRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::summit_xl_web::set_controller_optionsRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::summit_xl_web::set_controller_optionsRequest_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::summit_xl_web::set_controller_optionsRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::summit_xl_web::set_controller_optionsRequest_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xc803d4442092d317ULL;
  static const uint64_t static_value2 = 0xa92118964b891b96ULL;
};

template<class ContainerAllocator>
struct DataType< ::summit_xl_web::set_controller_optionsRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::summit_xl_web::set_controller_optionsRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::summit_xl_web::set_controller_optionsRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::summit_xl_web::set_controller_optionsRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::summit_xl_web::set_controller_optionsRequest_<ContainerAllocator>& v)
  {
    s << indent << "takeOver: ";
...
#endif // SUMMIT_XL_WEB_MESSAGE_SET_CONTROLLER_OPTIONSREQUEST_H
