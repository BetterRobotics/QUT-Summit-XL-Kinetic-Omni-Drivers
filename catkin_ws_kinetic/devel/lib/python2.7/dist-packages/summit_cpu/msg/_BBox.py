...
"""autogenerated by genpy from summit_cpu/BBox.msg. Do not edit."""
import sys
...
class BBox(genpy.Message):
  _md5sum = "9f54c175d8115e3773b15498f0018b75"
  _type = "summit_cpu/BBox"
...
string frame_id
"""
  __slots__ = ['image','person','lx','ux','ly','uy']
  _slot_types = ['sensor_msgs/Image','bool','int16','int16','int16','int16']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_B4h().pack(_x.person, _x.lx, _x.ux, _x.ly, _x.uy))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.person, _x.lx, _x.ux, _x.ly, _x.uy,) = _get_struct_B4h().unpack(str[start:end])
      self.person = bool(self.person)
      return self
