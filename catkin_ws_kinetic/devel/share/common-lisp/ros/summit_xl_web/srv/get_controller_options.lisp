...
;//! \htmlinclude get_controller_options-request.msg.html

(cl:defclass <get_controller_options-request> (roslisp-msg-protocol:ros-message)
  ()
)

(cl:defclass get_controller_options-request (<get_controller_options-request>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <get_controller_options-request>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'get_controller_options-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name summit_xl_web-srv:<get_controller_options-request> is deprecated: use summit_xl_web-srv:get_controller_options-request instead.")))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <get_controller_options-request>) ostream)
  "Serializes a message object of type '<get_controller_options-request>"
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <get_controller_options-request>) istream)
  "Deserializes a message object of type '<get_controller_options-request>"
  msg
)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<get_controller_options-request>)))
  "Returns string type for a service object of type '<get_controller_options-request>"
  "summit_xl_web/get_controller_optionsRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'get_controller_options-request)))
  "Returns string type for a service object of type 'get_controller_options-request"
  "summit_xl_web/get_controller_optionsRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<get_controller_options-request>)))
  "Returns md5sum for a message object of type '<get_controller_options-request>"
  "c803d4442092d317a92118964b891b96")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'get_controller_options-request)))
  "Returns md5sum for a message object of type 'get_controller_options-request"
  "c803d4442092d317a92118964b891b96")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<get_controller_options-request>)))
  "Returns full string definition for message of type '<get_controller_options-request>"
  (cl:format cl:nil "~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'get_controller_options-request)))
  "Returns full string definition for message of type 'get_controller_options-request"
  (cl:format cl:nil "~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <get_controller_options-request>))
  (cl:+ 0
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <get_controller_options-request>))
  "Converts a ROS message object to a list"
  (cl:list 'get_controller_options-request
))
;//! \htmlinclude get_controller_options-response.msg.html

(cl:defclass <get_controller_options-response> (roslisp-msg-protocol:ros-message)
  ((takeOver
    :reader takeOver
    :initarg :takeOver
    :type cl:boolean
...
(cl:defclass get_controller_options-response (<get_controller_options-response>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <get_controller_options-response>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'get_controller_options-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name summit_xl_web-srv:<get_controller_options-response> is deprecated: use summit_xl_web-srv:get_controller_options-response instead.")))

(cl:ensure-generic-function 'takeOver-val :lambda-list '(m))
(cl:defmethod takeOver-val ((m <get_controller_options-response>))
...
(cl:defmethod kinematicMode-val ((m <get_controller_options-response>))
...
(cl:defmethod gearboxReduction-val ((m <get_controller_options-response>))
...
(cl:defmethod diameterWheel-val ((m <get_controller_options-response>))
...
(cl:defmethod motionOdometry-val ((m <get_controller_options-response>))
...
(cl:defmethod motorsEncoder-val ((m <get_controller_options-response>))
...
(cl:defmethod motorsEncoderFactor-val ((m <get_controller_options-response>))
...
(cl:defmethod xWam-val ((m <get_controller_options-response>))
  ...
  (xWam m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <get_controller_options-response>) ostream)
  "Serializes a message object of type '<get_controller_options-response>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <get_controller_options-response>) istream)
  "Deserializes a message object of type '<get_controller_options-response>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<get_controller_options-response>)))
  "Returns string type for a service object of type '<get_controller_options-response>"
  "summit_xl_web/get_controller_optionsResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'get_controller_options-response)))
  "Returns string type for a service object of type 'get_controller_options-response"
  "summit_xl_web/get_controller_optionsResponse")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<get_controller_options-response>)))
  "Returns md5sum for a message object of type '<get_controller_options-response>"
  "c803d4442092d317a92118964b891b96")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'get_controller_options-response)))
  "Returns md5sum for a message object of type 'get_controller_options-response"
  "c803d4442092d317a92118964b891b96")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<get_controller_options-response>)))
  "Returns full string definition for message of type '<get_controller_options-response>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'get_controller_options-response)))
  "Returns full string definition for message of type 'get_controller_options-response"
  (cl:format cl:nil "bool takeOver~%string kinematicMode~%float32 gearboxReduction~%float32 diameterWheel~%string motionOdometry~%string motorsEncoder~%int32  motorsEncoderFactor~%string xWam~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <get_controller_options-response>))
  (cl:+ 0
     1
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <get_controller_options-response>))
  "Converts a ROS message object to a list"
  (cl:list 'get_controller_options-response
...
(cl:defmethod roslisp-msg-protocol:service-request-type ((msg (cl:eql 'get_controller_options)))
  'get_controller_options-request)
(cl:defmethod roslisp-msg-protocol:service-response-type ((msg (cl:eql 'get_controller_options)))
  'get_controller_options-response)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'get_controller_options)))
  "Returns string type for a service object of type '<get_controller_options>"
  "summit_xl_web/get_controller_options")